...
Тус судалгааны ажил нь практик судалгаа хэлбэрээр хэрэгжсэн бөгөөд Өвөрхангай аймгийн Хужирт сумын сувиллуудын утсаар захиалга авах, цаасан бүртгэл хөтлөх үйл явцыг цахимжуулах зорилготой. Хөгжүүлэлтийн аргачлалд Agile \cite{agilemanifesto2001} философид суурилсан давтамжтай хөгжүүлэлтийн аргыг сонгосон нь уламжлалт дараалсан хөгжүүлэлтийн загвараас ялгаатайгаар хэрэглэгчийн санал хүсэлтэд тулгуурлан системийг алхам алхмаар сайжруулах боломж олгодог.
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=1.5cm]
  \item \textbf{Процессын шинжилгээ} --- сувиллын ажилтнуудтай ярилцлага хийж, одоогийн захиалгын урсгал, цаасан бүртгэлийн асуудлуудыг баримтжуулах
  \item \textbf{Шаардлагын инженерчлэл} --- функционал болон функционал бус шаардлагуудыг системчлэн тодорхойлох
  \item \textbf{Архитектурын загварчлал} --- T3 Stack (Next.js, TypeScript, Prisma) технологийн стекийг сонгон, системийн ерөнхий бүтцийг боловсруулах
  \item \textbf{Өгөгдлийн сангийн дизайн} --- Prisma ORM \cite{prisma2024} ашиглан схемийг тодорхойлж, PostgreSQL \cite{postgresql2024}-г Supabase платформоор байршуулах
  \item \textbf{Серверийн хөгжүүлэлт} --- Next.js API Routes \cite{nextjs2024} болон NextAuth.js \cite{nextauth2024} ашиглан серверийн логик, нэвтрэлтийн системийг хэрэгжүүлэх
  \item \textbf{Хэрэглэгчийн интерфэйс} --- React компонентууд, TailwindCSS ашиглан харааны хэсгийг бүтээх
  \item \textbf{Туршилт ба үнэлгээ} --- нэгтгэлийн туршилт, ачааллын туршилт, хэрэглэгчийн сэтгэл ханамжийн судалгаа гүйцэтгэх
\end{enumerate}

Давталт бүрийн эцэст ажиллагаатай хувилбарыг гаргаж, удирдагч багш болон сувиллын ажилтнуудаас санал хүсэлт авч дараагийн давталтын ажлыг төлөвлөсөн. Энэ арга нь хөгжүүлэлтийн явцад гарсан техникийн болон хэрэглэгчийн туршлагын асуудлуудыг эрт илрүүлж засварлах боломжийг олгосон.
...
% ======= 3.3 (Суурь судалгаа) =======
\section{Судалгааны суурь судалгаа}
...
\subsection{Концуррент захиалгын туршилтын дизайн}

Олон хэрэглэгч нэгэн зэрэг ижил өрөөг захиалах оролдлогод систем давхар бүртгэл үүсгэхгүй байх чадварыг шалгана. $N=\{5,\,20,\,50\}$ виртуал хэрэглэгч нэгэн зэрэг яг ижил \texttt{room\_id} болон огноонд HTTP POST захиалга илгээх бөгөөд туршилтыг тус бүр 10 давталтаар гүйцэтгэнэ. Давталт бүрд зөвхөн нэг хүсэлт амжилтанд хүрч, бусад бүх хүсэлт алдааны хариу буцаах ёстой. Үзүүлэлт: давхар захиалгын нийт тоо (0 байх ёстой), амжилттай болон татгалзсан хүсэлтийн тоо, дундаж хариу хугацаа (ms). Хэрэгжүүлэлт: PostgreSQL pessimistic locking (\texttt{SELECT ... FOR UPDATE}) болон EXCLUDE constraint.

\subsection{Гүйцэтгэлийн туршилтын дизайн}

API endpoint-уудын ачааллын хариу хугацааг хэмжихийн тулд \textbf{k6} \cite{k6docs2024} хэрэгслийн ачааллын туршилтыг дизайнласан. Тохиргоо: 10 виртуал хэрэглэгч (VU), 5 минутын гүйцэтгэл, эхний 1 минутад ачааллыг шатлан нэмэгдүүлэх ramp-up стратеги. Шалгах endpoint-уудын хэмжүүр: p50, p95, p99 хариу хугацаа (ms), нийт хүсэлтийн амжилтын хувь, NFR-01-д заасан 2000\,ms хязгаарт багтаж байгаа эсэх.
...
\subsection{SUS хэрэглэхэд хялбар байдлын судалгааны арга}

Системийн ашиглах чадварыг (usability) стандарт аргачлалаар хэмжихийн тулд \textbf{System Usability Scale (SUS)} \cite{brooke1996sus} ашиглана. SUS нь 10 асуултаас бүрдэх бөгөөд 5 оноотой Likert scale-ээр үнэлж, нийт оноог тооцоолох томьёо нь $\mathrm{SUS} = 2.5 \times \sum_{i=1}^{10} x_i$ бөгөөд $x_i$ нь тохируулсан хариулт (сондгой асуулт: хариулт~$-1$; тэгш асуулт: $5-$хариулт) юм. Судалгаанд $n=13$ оролцогч (3 ажилтан + 10 амрагч) 2 долоо хоногийн туршилтын дараа Google Form-оор асуулгыг бөглүүлнэ. Дүгнэлтийн шалгуур: Bangor нарын (2008) \cite{bangor2008sus} стандартаар $\geq 68$ оноо ``хүлээн зөвшөөрөгдөхүйц'' (acceptable) гэж тооцогдоно.

\subsection{Функциональ шаардлагын шалгалтын арга}

Системийн FR-01--FR-09 шаардлагуудыг (Хүснэгт \ref{tab:functional-req}) хосолсон стратегиэр шалгана: (а) \textbf{Playwright} \cite{playwright2024} автоматжуулсан E2E туршилт нэвтрэх, захиалга үүсгэх болон баталгаажуулах урсгалуудыг шалгана; (б) гар аргаар UI туршилт үүрэг бүрийн эрхийн хязгаарлалт (role-based access control) болон граничийн утгуудын нөхцлүүдийг шалгана; (в) API endpoint туршилт HTTP статус кодын зөвлөл болон JSON хариуллын бүтцийн зөвлөлийг шалгана.

\subsection{Аюулгүй байдлын шалгалтын арга}

OWASP Top 10 \cite{owasp2021} удирдамжид суурилан дараах зургаан шалгалтыг дизайнласан: (а) SQL injection --- 6 payload (\texttt{' OR '1'='1} гэх мэт)-ийг Prisma ORM параметржуулалтаар хаагдаж байгаа эсэхийг шалгах; (б) Session security --- \texttt{httpOnly}, \texttt{secure}, \texttt{SameSite=Lax} cookie тохиргоог баталгаажуулах; (в) Нууц үг хэшлэх --- bcrypt \cite{provos1999bcrypt} rounds=12 тохиргоог шалгах; (г) Rate limiting --- \texttt{/api/auth} хүсэлтэд IP хаягийн хязгаарыг шалгах; (д) JWT токены бүрэн бүтэн байдал --- NextAuth.js session хамгаалалтыг шалгах; (е) HTTPS протокол --- Vercel байршуулалтын TLS шифрлэлтийг шалгах.

\subsection{End-to-End захиалгын урсгалын туршилтын арга}

Системийн бодит хэрэглэгчийн туршлагыг дуурайлган 8 алхамтай E2E туршилтыг \textbf{Playwright} \cite{playwright2024}-аар дизайнласан: (1) нүүр хуудасруу хандах; (2) огноо болон хүний тоо сонгох; (3) боломжит өрөөний мэдээлэл харах; (4) үйлчилгээний багц сонгох; (5) нэвтэрч \texttt{PENDING} захиалга үүсгэх; (6) ажилтнаар нэвтэрч \texttt{CONFIRMED} баталгаажуулах; (7) имэйл мэдэгдлийн илгээгдэлт шалгах; (8) статистик дашбоардад бүртгэгдсэн эсэхийг баталгаажуулах. Инвариант шалгалт: \texttt{created\_at < confirmed\_at} timestamp-үүдийн дарааллын зөвлөл. Хэмжүүр: нийт гүйцэтгэлийн хугацаа (сек), алхам бүрийн амжилт.

% ======= 3.5 (Системийн үйл ажиллагааны тухай) =======
